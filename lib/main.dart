                      ...
                      Container(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            ...
                            SizedBox(height: 10,),
                             Center(child: Text("It's Perfectly Clear Right Now, this pixel is a ready to fly in the monitor for the t", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),))
                          ],
                        ),
                      ),
                    ],
