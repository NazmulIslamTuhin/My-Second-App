             ...
             child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ...
                  Container(
                    ...
                    child:const Text ("3Clear conditions tonight,continuing through the morning.Wind gusts are up to 10km/h.",
                            ...
                            children:[
                              Column(mainAxisAlignment: MainAxisAlignment.spaceAround ,
                                  children:[
                                    ...
                                    SizedBox( height: 15,),
                                    Center(child: Text("6:21 PM", style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold,),)),
                                    SizedBox(height: 20,),
                  ...
                  Container(
                    ...
                    children: [
                      Row(mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Report an Issue", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.red, fontStyle: FontStyle.italic),),
                        ],
                      ),
                      SizedBox(height: 25,),
                      Row(crossAxisAlignment: CrossAxisAlignment.center,
